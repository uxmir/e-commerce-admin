      ...
      <CardHeader className="items-center pb-0 px-0">
        ...
        <CardDescription>
          <div className="flex flex-col gap-y-4">
            <ChartLabel text="electronies" />
            <ChartLabel text="fashion" bgColor="bg-[#34D399]" />
            <ChartLabel text="accessories" bgColor="bg-[#FBBF24]" />
          </div>
        </CardDescription>
      </CardHeader>
          ...
          <PieChart>
            <ChartTooltip
              ...
              content={
                <ChartTooltipContent
                  hideLabel
                  className="bg-white text-black dark:text-white border-gray-200 shadow-md"
                />
              }
            />
            <Pie
...
const ChartLabel: React.FC<labelProps> = ({
  ...
  return (
    <>
      <div className="flex gap-x-2 items-center text-gray-600 dark:text-white capitalize">
        <span>{text} </span> <div className={`w-8 h-3 ${bgColor}`}></div>
      </div>
    </>
  );
};
