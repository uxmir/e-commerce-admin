...
const TopBar:React.FC = () => {
  ...
  return (
    <div onClick={handleSidebar} className={`py-3 w-full pr-5 cursor-pointer  transition-all duration-500 bg-white  border-b border-gray-200 ${sidebar===true?' pl-10 lg:pl-74':'pl-10'}`}>
      <div>
